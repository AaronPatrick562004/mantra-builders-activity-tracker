  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto px-4 py-4 sm:px-6 md:px-8 lg:max-w-4xl">
        {/* Welcome Banner */}
        <div className="mb-4 sm:mb-6 rounded-xl bg-linear-to-r from-green-700 to-green-600 p-4 sm:p-6 text-white">
        ...
        <Card className="mb-4 sm:mb-6 border-green-700/20 bg-green-700/5">
          <CardContent className="p-4 sm:p-6">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="font-mono text-xl sm:text-3xl font-bold text-green-700">{stats.completedProjects}</p>
                <p className="text-xs text-gray-600 mt-1">Completed</p>
              </div>
              <div>
                <p className="font-mono text-xl sm:text-3xl font-bold text-green-700">{stats.ongoingProjects}</p>
                <p className="text-xs text-gray-600 mt-1">Ongoing</p>
              </div>
              <div>
                <p className="font-mono text-xl sm:text-3xl font-bold text-green-700">{stats.legacyYears}</p>
